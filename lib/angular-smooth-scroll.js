...
(function () {
     ...
     * 20200222 EDIT - nonplus
     * 	Added new option - container to account for scrolling within a DIV
     * 	Copied fix from https://github.com/d-oliveros/ngSmoothScroll/pull/86
	 */
	var smoothScroll = function (element, options) {
		...
		var duration = options.duration || 800,
			...
			container = options.container || document.getElementById(options.containerId) || null,
